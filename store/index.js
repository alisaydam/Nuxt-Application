...
export const getters    ={
    getProductById : (state) =>(id) =>{
        //* Go and iterate thru products array in state and get every item as product and equate their id to the payload we pass into method.
        //*find() gets the first matched one.
